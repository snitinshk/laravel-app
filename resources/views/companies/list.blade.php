@extends('master2', ['menu_group' => 'Companies', 'slug' => "CompanyList", 'page_title' => "Companies List"])
@section('content')
            ...
            <table id="zero-config" class="table dt-table-hover" style="width:100%">
                ...
                @foreach($TableArray as $TableRow)
                    <tr>
                        ...
                        <td>{{ $TableRow[4] }}</td>
                        <td>
                            <a href="/company/view/{{ $TableRow[0] }}" style="width: 27px; height: 27px; margin-right: 10px; float: left;"><div class="table_button">
                            ...
                            <a href="/company/export/{{ $TableRow[0] }}" style="width: 27px; height: 27px; margin-right: 10px; float: left;"><div class="table_button">
                            ...
                            <a href="/company/delete/{{ $TableRow[0] }}" style="width: 27px; height: 27px; margin-right: 10px; float: left;"><div class="table_button">
