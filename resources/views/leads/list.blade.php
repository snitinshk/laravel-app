@extends('master2', ['menu_group' => 'Leads', 'slug' => "MyLeads", 'page_title' => "My Leads"])
@section('content')
                ...
                <tbody>
                    @foreach($TableArray as $TableRow)
                        <tr>
                            ...
                            <td>{{ $TableRow[4] }}</td>
                            <td>
                                <a href="/lead/view/{{ $TableRow[0] }}" style="width: 27px; height: 27px; margin-right: 10px; float: left;">
                                ...
                                <a href="/lead/delete/{{ $TableRow[0] }}" style="width: 27px; height: 27px; margin-right: 10px; float: left;"><div class="table_button">
