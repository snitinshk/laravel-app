    ...
    <div class="row">
        <div class="col-md-4" style="position: fixed; top: 15rem; left: 12rem; ">
            ...
            <div style="height: 480px; width: 400px; padding-bottom: 40px; position: relative; z-index: 100;">
                ...
                <p style="font-size: 24px; font-weight: 400; padding: 25px 0 0 0; color: #ffffff;">Reset Password</p>
                ...
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <input type="hidden" name="email" placeholder="Email Address" value="{{ $request->email }}" require autofocus style="width: 40rem; height: 45px; margin: 1px 0 10px 0; font-size: 18px; font-weight: 500; padding: 7px 13px 7px 13px; border: 0; border-radius: 12px; background: white;">

                    <p style="font-size: 17px; font-weight: 400; padding: 25px 0 0 0; color: #ffffff;">New Password</p>
                    <input type="password" name="password" placeholder="Password" require style="width: 40rem; height: 45px; margin: 1px 0 10px 0; font-size: 18px; font-weight: 500; padding: 7px 13px 7px 13px; border: 0; border-radius: 12px; background: white;">

                    <p style="font-size: 17px; font-weight: 400; padding: 25px 0 0 0; color: #ffffff;">Confirm Password</p>
                    <input type="password" name="password_confirmation" placeholder="Confirm Password" require style="width: 40rem; height: 45px; margin: 1px 0 10px 0; font-size: 18px; font-weight: 500; padding: 7px 13px 7px 13px; border: 0; border-radius: 12px; background: white;">
